...
function filterPremiumByViews(users) {
    ...
    const filteredPremiumUsers =  users.filter((user) => user.subscriptionType === 'premium');
    // Calculate total views
    // Solve it by yourself
    
    // Calculate total views for each premium user using the map and reduce fuunction
    return filteredPremiumUsers.map(user => {
...
console.log(filterPremiumByViews(users), 'filtered')
